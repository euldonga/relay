...
//		byte[] checksum = packet.substring(len-2, len);
//		return "";
//	}
	
	public static void main(String[] args) {
		String sample = "fd3e000035c701690000c374fb7f000000000f01f0bd625fddbdda11dbc052496ebc32a4c43a60454a3b2adf15bc9e7f5ebe6dd0dcbe00000000d2cccc3d1a86f54300000042ff1b48d3";
//		MavlinkHandler handler = new MavlinkHandler();
//		String secretKey = handler.getSecretKey(sample);
//		System.out.println(secretKey);
		checksum(sample);
	
	}
	
	public static void checksum(String data) {
...
//		int[] table = new int[data.length() / 2];
//		for (int i = 0; i < table.length; i++) {
//			table[i] = Integer.parseInt(data.substring(i * 2, (i * 2) + 2), 16);
//		}
